...
parser.add_argument('--result_path', default='D:/code/MSB/psnrssim/results/UAV-Rain1k', help='Generated, Restored and Recovered images -path')
parser.add_argument('--target_path', default='D:/code/MSB/psnrssim/GT/UAV-Rain1k', help='Ground-truth -path')
