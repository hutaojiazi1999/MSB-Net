...
parser.add_argument('--train_dir', default='D:/code/code/Datasets/Haze1k/Haze1k_thin/dataset/train', type=str, help='Directory of train images')
parser.add_argument('--val_dir', default='D:/code/code/Datasets/Haze1k/Haze1k_thin/dataset/test', type=str, help='Directory of validation images')
