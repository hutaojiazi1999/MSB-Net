...
parser.add_argument('--input_dir', default='D:/code/code/Datasets/Haze1k/Haze1k_thin/dataset/test/input/', type=str, help='Directory of validation images')
parser.add_argument('--output_dir', default='./results/Haze1k/Haze1k_thin', type=str, help='Directory of validation images')
parser.add_argument('--weights', default='F:/Finland/CVPR2024/chec0kpoints/Deraininig/models/Multiscale/model_best.pth', type=str, help='Path to weights')
